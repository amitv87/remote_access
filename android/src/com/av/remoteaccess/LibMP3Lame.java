...
public class LibMP3Lame {
    public static final String TAG = LibMP3Lame.class.getCanonicalName();

    static {
        System.loadLibrary("Lame");
        Log.d(TAG, "Loaded native library.");
    }
    public static native int pcm2mp3(short[] pcm, int pcmlen, int sampleRate, int channels, byte[] mp3);
